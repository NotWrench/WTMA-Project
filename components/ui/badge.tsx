  ...
  "relative inline-flex w-fit shrink-0 items-center justify-center whitespace-nowrap border border-transparent font-medium outline-none transition-shadow focus-visible:ring-2 focus-visible:ring-ring focus-visible:ring-offset-1 focus-visible:ring-offset-background disabled:pointer-events-none disabled:opacity-50 [&_svg:not([class*=size-])]:size-3 [&_svg]:pointer-events-none [&_svg]:shrink-0",
  {
    variants: {
      variant: {
        ...
        outline:
          "border-border/20 bg-surface-container-lowest text-foreground dark:bg-input/32",
        ...
        "primary-outline":
          "border-border/20 bg-surface-container-lowest text-primary dark:bg-input/30",
        "warning-outline":
          "border-border/20 bg-surface-container-lowest text-warning-foreground dark:bg-input/30",
        "success-outline":
          "border-border/20 bg-surface-container-lowest text-success-foreground dark:bg-input/30",
        "info-outline":
          "border-border/20 bg-surface-container-lowest text-info-foreground dark:bg-input/30",
        "destructive-outline":
          "border-border/20 bg-surface-container-lowest text-destructive-foreground dark:bg-input/30",
        "invert-outline":
          "border-border/20 bg-surface-container-lowest text-invert-foreground dark:bg-input/30",
        "focus-outline":
          "border-border/20 bg-surface-container-lowest text-focus-foreground dark:bg-input/30",
      },
      size: {
