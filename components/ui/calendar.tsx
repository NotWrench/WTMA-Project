...
/** biome-ignore-all lint/performance/noNamespaceImport: why not */
/** biome-ignore-all lint/correctness/noNestedComponentDefinitions: why not */
/** biome-ignore-all lint/suspicious/noDuplicateJsxProps: why not */
"use client";
