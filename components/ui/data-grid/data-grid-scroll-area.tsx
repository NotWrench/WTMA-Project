      ...
      >
        ...
        {showHorizontal && (
          <ScrollAreaPrimitive.Scrollbar
            className="flex touch-none select-none p-px transition-colors data-[orientation=horizontal]:h-2.5 data-[orientation=vertical]:h-full data-[orientation=vertical]:w-2 data-[orientation=horizontal]:flex-col"
            data-orientation="horizontal"
            data-slot="data-grid-scrollbar"
            orientation="horizontal"
          >
            <ScrollAreaPrimitive.Thumb
              className="relative flex-1 rounded-full bg-surface-container-highest"
      ...
      {usesCustomVerticalScrollbar && hasCustomVerticalOverflow && (
        ...
        >
          ...
          >
            <div
              className={cn(
                "absolute end-px w-2 bg-surface-container-highest",
